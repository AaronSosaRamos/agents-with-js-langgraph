...
const messages4 = [new HumanMessage('What is a Large Language Model?')];

const result4 = await graph.invoke({messages: messages4});
console.log('Result: ' + result4.messages[result4.messages.length-1].content);
